...
Other:
- [`lib/utils/style.dart`](/lib/utils/style.dart) for app theme colors and style
- [`lib/utils/localize.dart`](/lib/utils/localize.dart) for app localization functions
- [`lib/utils/pb_service.dart`](/lib/utils/pb_service.dart) for pocketbase related functions
- [`lib/utils/model.dart`](/lib/utils/model.dart) with base classes for data objects and factories
- [`lib/utils/misc.dart`](/lib/utils/misc.dart) for other utilities like `navigateToPage`
